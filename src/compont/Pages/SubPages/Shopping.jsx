...
const Shopping = () => {
  ...
  const checkToggle = () => {
    ...
    document.querySelector('#filter-section-0').classList.toggle('hidden');
    document.querySelector('#contentOne').classList.toggle('rotate-45');
  ...
  const section1 = () => {
    ...
    document.querySelector('#filter-section-1').classList.toggle('hidden');
    document.querySelector('#contentOne').classList.toggle('rotate-45');
  ...
  const section2 = () => {
    ...
    document.querySelector('#filter-section-2').classList.toggle('hidden');
    document.querySelector('#contentOne').classList.toggle('rotate-45');
  ...
  return (
    <div>
      ...
      <OffCanves />
      <NavBar />
      <div class=" absolute pl-24 w-[1000px] bg-white">
        <div>
              ...
              <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <form class="hidden lg:block">
                  ...
                  <ul role="list"
                    ...
                    <li>
                      <a href="#">100% Hand made</a>
                    </li>

                    <li>
                      <a href="#">Hand made flowers</a>
                    </li>
                  </ul>
                  ...
                  <div class="border-b border-gray-200 py-6">
                    <h3 class="-my-3 flow-root">
                      {/* -- Expand/collapse section button -*/}
                      <button onClick={checkToggle} type="button"
                        ...
                        <span class="ml-6 flex items-center">
                          {/* 
                            ...
                            Heroicon name: mini/plus
                                */}
                          <svg id="contentOne" className="h-5 w-5  rotate-90"
                  ...
                  <div class="border-b border-gray-200 py-6">
                    <h3 class="-my-3 flow-root">
                      ...
                      {/* -- Expand/collapse section button -*/}
                      <button onClick={section1} type="button"
                        class="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500"
                        aria-controls="filter-section-1" aria-expanded="false">
                        <span class="font-medium text-gray-900">Category</span>
                        <span class="ml-6 flex items-center">

                          <svg class="h-5 w-5 rotate-90" id="Catagory"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                            fill="currentColor" aria-hidden="true">
                            <path
                              d="M10.75 4.75a.75.75 0 00-1.5 0v4.5h-4.5a.75.75 0 000 1.5h4.5v4.5a.75.75 0 001.5 0v-4.5h4.5a.75.75 0 000-1.5h-4.5v-4.5z" />
                  ...
                  <div class="border-b border-gray-200 py-6">
                    <h3 class="-my-3 flow-root">
                      ...
                      {/*-- Expand/collapse section button --*/}
                      <button type="button" onClick={section2}
                        class="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500"
                        ...
                        <span class="ml-6 flex items-center">
                          ...
                          <svg id="Size" class="h-5 w-5 rotate-90" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                            fill="currentColor" aria-hidden="true">
                            <path
                              d="M10.75 4.75a.75.75 0 00-1.5 0v4.5h-4.5a.75.75 0 000 1.5h4.5v4.5a.75.75 0 001.5 0v-4.5h4.5a.75.75 0 000-1.5h-4.5v-4.5z" />
                          </svg>
